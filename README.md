...
5. A candidate opens the link in Telegram → picks a **language** (uz/ru/en) → uploads a resume
   → the bot offers to add an optional **cover letter** (text or file); it's folded into the AI analysis.
...
- **Multilingual bot** — on `/start` the candidate picks a language (🇺🇿 / 🇷🇺 / 🇬🇧); all bot
  system messages are localized (Uzbek / Russian / English) and the choice is remembered.
